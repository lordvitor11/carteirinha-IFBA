<?php session_start();
    function showNav($call) {
        ...
        if ($call == "login") {
            ...
            echo "<nav><div><a href='../index.php'>Início</a><a href='cardapio.php'>Cardápio</a><a href='cardapio-admin.php'>Cardápio ADMIN</a><a href='sobre.php'>Sobre</a></div>{$text}</nav>";
        }
    }
?>