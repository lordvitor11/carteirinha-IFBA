...
<head>
    ...
    <link rel="stylesheet" href="css/aprovado.css">
</head>
<body>
    ...
    <div class="center">
        <img src="../assets/aprovado.png" alt="Reserva Aprovada" class="approved-image">
        <div class="confirmation-message">
            <p>Seu pedido foi aprovado! Você tem uma reserva confirmada.</p>
        </div>
    </div>
