...
<body>
    ...
    <div class="session-4">
        <aside class="carousel">
            ...
            <div class="item" id="slide-0"><img src="assets/image1.jpeg" alt="" width="418" height="418"/></div>
            <div class="item" id="slide-1"><img src="assets/image2.jpeg" alt="" width="418" height="418"/></div>
            <div class="item" id="slide-2"><img src="assets/image3.jpeg" alt="" width="418" height="418"/></div>
            <div class="item" id="slide-3"><img src="assets/image1.jpeg" alt="" width="418" height="418"/></div>
            <div class="item" id="slide-4"><img src="assets/image2.jpeg" alt="" width="418" height="418"/></div>
            <div class="item" id="slide-5"><img src="assets/image3.jpeg" alt="" width="418" height="418"/></div>
            <div class="item" id="slide-6"><img src="assets/image1.jpeg" alt="" width="418" height="418"/></div>
            </div>
        </aside>
        <article class="instagram">
            <header class="instagram__header">
            <figure><img src="assets/profile_instagram.png" alt="Jake Dog" width="42" height="42"/>
                <figcaption>
                <h4>IFBA SEABRA</h4>
                </figcaption>
            </figure>
